...
class Video:
    """Outputs the game state. The responsiblilty of the class of objects if to draw the game state
    on the screen.
    """
    ...
    def clear_buffer(self):
        """Clears the buffer in preparation for the next rendering. This method should be called
